    ...
    module IdentityProtection
        module RiskyUsers
            module ConfirmSafe
                ...
                class ConfirmSafeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityProtection/riskyUsers/confirmSafe")
                    end
                    ## 
                    ...
                    ## @return a confirm_safe_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ConfirmSafeRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
