...
require_relative './confirm_safe/confirm_safe_request_builder'
        ...
        module SignIns
            ...
            class SignInsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def confirm_compromised()
                    return MicrosoftGraph::AuditLogs::SignIns::ConfirmCompromised::ConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the confirmSafe method.
                def confirm_safe()
                    return MicrosoftGraph::AuditLogs::SignIns::ConfirmSafe::ConfirmSafeRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def dismiss()
                    return MicrosoftGraph::AuditLogs::SignIns::Dismiss::DismissRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the signIns property of the microsoft.graph.auditLogRoot entity.
