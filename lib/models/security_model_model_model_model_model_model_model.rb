...
module MicrosoftGraph
    module Models
        class SecurityModelModelModelModelModelModelModel < MicrosoftGraph::Models::Entity
            ...
            ## 
            def data_security_and_governance
                return @data_security_and_governance
            end
            ## 
            ...
            ## @return a void
            ## 
            def data_security_and_governance=(value)
                @data_security_and_governance = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "dataSecurityAndGovernance" => lambda {|n| @data_security_and_governance = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::TenantDataSecurityAndGovernance.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("dataSecurityAndGovernance", @data_security_and_governance)
