        ...
        class .models.partners.billingBillingReconciliation < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "unbilled" => lambda {|n| @unbilled = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::.models.partners.billingUnbilledReconciliation.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
