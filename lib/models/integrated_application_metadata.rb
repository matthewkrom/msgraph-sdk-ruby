...
module MicrosoftGraph
    module Models
        class IntegratedApplicationMetadata
            ...
            ## 
            ## Instantiates a new IntegratedApplicationMetadata and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.protectedApplicationMetadata"
                            return ProtectedApplicationMetadata.new
                    end
                end
                return IntegratedApplicationMetadata.new
            end
            ## 
