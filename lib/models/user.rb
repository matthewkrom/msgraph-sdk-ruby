        ...
        class User < MicrosoftGraph::Models::DirectoryObject
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "dataSecurityAndGovernance" => lambda {|n| @data_security_and_governance = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::UserDataSecurityAndGovernance.create_from_discriminator_value(pn) }) },
