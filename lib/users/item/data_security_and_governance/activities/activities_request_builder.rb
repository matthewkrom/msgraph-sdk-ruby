...
require_relative '../../../../models/activities_container'
require_relative '../../../../models/o_data_errors_o_data_error'
require_relative '../../../users'
require_relative '../../item'
require_relative '../data_security_and_governance'
require_relative './activities'
require_relative './content_activities/content_activities_request_builder'
                ...
                module Activities
                    ...
                    class ActivitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def content_activities()
                            return MicrosoftGraph::Users::Item::DataSecurityAndGovernance::Activities::ContentActivities::ContentActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance/activities{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of activities_container
                        ## 
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::ActivitiesContainer.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
