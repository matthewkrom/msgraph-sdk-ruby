...
require_relative './data_security_and_governance/data_security_and_governance_request_builder'
        ...
        module Item
            ...
            class UserItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def data_security_and_governance()
                    return MicrosoftGraph::Users::Item::DataSecurityAndGovernance::DataSecurityAndGovernanceRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
